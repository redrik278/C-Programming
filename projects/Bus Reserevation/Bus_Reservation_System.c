...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Green Line","Hanif Paribahan","Sohag Express","Shyamoli Paribahan","Ena Travels","Desh Travels"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
int main()
{
    ...
    system("cls");
    printf("\n\n\n");
   printf("====================================== Welcome to RedRik Travels ======================================\n\n\n");
...
printf("\n\t\t\t\tThe Total booking amount is %d",1400*booking);
itoa(seat1, str1, 10);
    ...
    do
{
	...
	i=0;
	//scanf("%s",&pword); 
		if(strcmp(uname,"red")==0 && strcmp(pword,"rik")==0)
	{
	printf(" \n\n\n         Access Granted! \n\n\n          ");
